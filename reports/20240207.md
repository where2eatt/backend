...
#### Section 1 
- Goals
  - Work on backend functions to login and create user
  - Add functionality to create DynamoDB tables for users and sessions
#### Section 2
...
#### Section 1 
- Goals
  - Work on backend functions to create a session
  - Work on basic chat functionality
  - Implement simple recomendation algorithm
